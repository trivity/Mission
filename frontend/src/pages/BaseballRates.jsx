  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white py-20 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://mcsportspark.org/wp-content/uploads/2014/02/mcsports-9-e1392654617877.jpg')] bg-cover bg-center opacity-10"></div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <img
              src="https://mcsportspark.org/wp-content/uploads/2014/02/mcsports-9-e1392654617877.jpg"
              alt="Baseball Fields"
