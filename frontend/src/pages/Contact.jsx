  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['714 E. Theo Ave.', 'San Antonio, TX 78210'],
      link: 'https://maps.google.com/?q=714+E.+Theo+Ave+San+Antonio+TX+78210'
    },
    {
      icon: Phone,
      title: 'Call Us',
      details: ['(210) 477-8900'],
      link: 'tel:2104778900'
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['info@mcsportspark.org'],
      link: 'mailto:info@mcsportspark.org'
    },
    {
      icon: Clock,
      title: 'Hours',
      details: ['Mon-Fri: 8am - 10pm', 'Sat-Sun: 7am - 11pm'],
      link: null
    }
  ];
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-6 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                      {isSubmitting ? (
                        'Sending...'
                      ) : (
